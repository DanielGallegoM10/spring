...
public class App {
    ...
    public static void main(String[] args) {
        ...
        List<Product> products = List.of(
                new Product(null, "Pantalón", 5.99, 1, categories.get(0)),
                new Product(null, "Sudadera", 6.99, 2, categories.get(0)),
                new Product(null, "Zapatos", 7.99, 4, categories.get(1)),
                new Product(null, "Mancuerna", 8.99, 2, categories.get(0)),
                new Product(null, "Rodillera", 8.99, 2, categories.get(0)),
                new Product(null, "Balón", 8.99, 2, categories.get(0)),
                new Product(null, "Zapatillas", 69.99, 20, categories.get(1))
        );
